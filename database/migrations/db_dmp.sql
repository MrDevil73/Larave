...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 06 2023 г., 23:46
...
(8, 0, 0, 'Lessons', 'fa-laptop', '/lessons', NULL, '2023-12-05 04:02:33', '2023-12-05 04:08:16'),
(9, 0, 0, 'Courses', 'fa-file-text', '/courses', NULL, '2023-12-05 04:06:48', '2023-12-05 04:08:36');
...
(1, 'Administrator', 'administrator', '2023-10-22 11:17:17', '2023-10-22 11:17:17');
...
(1, 'admin', '$2y$10$ptw.ZQaS/xXvo2KNrYK6Eewg02ZAwkz0ENW5PCPyF.2kY1IE2hGhu', 'Administrator', NULL, 'RClY21eEWQ0jsNlbaOSlj8RlSF6frCvi6N0dGhwX9YzASXx21HiaAuEHjIAU', '2023-10-22 11:17:17', '2023-10-22 11:17:17');
...
--
-- Дамп данных таблицы `completions`
--
...
(1, 'Курс по Анализу данных', 'Оно вам не надо', NULL, NULL),
(2, 'Курс по информационной безопасности', 'ОООочень интересные лабы', NULL, NULL),
(3, 'Курс программирования', 'круто!', '2023-12-05 04:11:16', '2023-12-05 04:11:16');
...
(1, 1, 'Что такое Numpy', 'Бесполезная библиотека', NULL, NULL),
(2, 3, 'Питон', 'Всё круто!', '2023-12-05 04:11:36', '2023-12-05 04:11:36');
...
--
-- Индексы таблицы `completions`
--
ALTER TABLE `completions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `completions_user_id_foreign` (`user_id`),
  ADD KEY `completions_course_id_foreign` (`course_id`);
...
--
-- AUTO_INCREMENT для таблицы `completions`
--
ALTER TABLE `completions`
...
--
-- Ограничения внешнего ключа таблицы `completions`
--
ALTER TABLE `completions`
  ADD CONSTRAINT `completions_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  ADD CONSTRAINT `completions_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
